<nav class="fixed top-0 w-full z-50 bg-[#0A192F]/80 backdrop-blur-xl border-b border-outline-variant/30 transition-all duration-300 shadow-lg">
    <div class="flex justify-between items-center h-20 px-8 max-w-screen-2xl mx-auto">
        <div class="flex items-center gap-4">
            <div class="text-xl font-bold tracking-tighter text-[#f0f4f8] font-headline uppercase flex items-center gap-2">
                <span class="w-8 h-8 rounded bg-primary flex items-center justify-center text-xs">13</span>
                STI 2026
            </div>
        </div>
